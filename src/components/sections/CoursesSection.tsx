...
const courses: Course[] = [
  {
    ...
    description: 'Ідеальний старт для тих, хто ніколи не тримав голку з намистинами. Крок за кроком від нуля до готового клатчу.',
    level: 'Початковий',
    duration: '3–4 години',
    format: 'Онлайн або офлайн',
    topics: [
      'Вибір намистин та інструментів',
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          >
            ...
            сумочок з намистин з нуля або вдосконалити свої навички.
          </motion.p>
        </div>
